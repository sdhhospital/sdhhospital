        ...
        <div class="row mb-5">
            <div class="col-md-3">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2">Seven Day <span>Homeopathic</span> Hospital</h2>
...
<script src="<?php echo base_url();?>application/assets/js/jquery-migrate-3.0.1.min.js"></script>
...
<script src="<?php echo base_url();?>application/assets/js/aos.js"></script>
<script src="<?php echo base_url();?>application/assets/js/jquery.animateNumber.min.js"></script>
