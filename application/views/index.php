...
<?php $this->load->view('inc/navbar');?>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image: url('application/assets/images/bg_1.jpg');">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            <div class="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Modern Homeopathic Doctors in a Calm and Relaxed Environment</h1>
              ...
              <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><a href="<?php echo base_url();?>contact" class="btn btn-primary px-4 py-3"  data-toggle="modal" data-target="#modalRequest">Make an Appointment</a></p>
            </div>
          </div>
        </div>
      </div>

      <div class="slider-item" style="background-image: url('application/assets/images/bg_2.jpg');">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">
            <div class="col-md-6 col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              ...
              <p><a href="<?php echo base_url();?>contact" class="btn btn-primary px-4 py-3" data-toggle="modal" data-target="#modalRequest">Make an Appointment</a></p>
            </div>
          </div>
        </div>
      </div>
...
<!--    			<div class="col-md-3 color-1 p-4 rounded-left">-->
<!--    				<h3 class="mb-4">Emergency Cases</h3>-->
<!--    				<p>A small river named Duden flows by their place and supplies</p>-->
<!--    				<span class="phone-number">+ (123) 456 7890</span>-->
<!--    			</div>-->
    			<div class="col-md-12 col-sm-12 col-xs-12 color-3 p-4 rounded-top">
    				<h3 class="mb-4">Opening Hours</h3>
                    <p class="openinghours d-flex">
                        <span><b>Days</b></span>
                        <span><b>Morning Time</b></span>
                        <span><b>Evening Time</b></span>
                    </p>
    				<p class="openinghours d-flex">
                        <span>Monday</span>
...
<!--    			<div class="col-md-6 color-3 p-4 rounded-right">-->
...
<!--            		<span class="flaticon-tooth-1"></span>-->
              ...
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Heart Bypass</h3>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Kidney dialysis</h3>
              </div>
            </div>    
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Back Bone pain</h3>
              </div>
            </div>      
          </div>
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <h3 class="heading">Tuberculosis</h3>
              </div>
            </div>      
          </div>
        </div>
      ...
      <div class="container-wrap mt-5">
      	<div class="row d-flex no-gutters">
      		<div class="col-md-6 img" style="background-image: url('application/assets/images/about-2.jpg');">
      		</div>
...
<!--        		<div class="staff">-->
<!--      				<div class="img mb-4" style="background-image: url('application/assets/images/person_5.jpg');"></div>-->
...
<!--        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">-->
<!--        		<div class="staff">-->
<!--      				<div class="img mb-4" style="background-image: url('application/assets/images/person_6.jpg');"></div>-->
<!--      				<div class="info text-center">-->
...
<!--        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">-->
<!--        		<div class="staff">-->
<!--      				<div class="img mb-4" style="background-image: url('application/assets/images/person_7.jpg');"></div>-->
<!--      				<div class="info text-center">-->
...
<!--        	<div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate">-->
<!--        		<div class="staff">-->
<!--      				<div class="img mb-4" style="background-image: url('application/assets/images/person_8.jpg');"></div>-->
<!--      				<div class="info text-center">-->
...
<!--        </div>-->
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url('application/assets/images/bg_1.jpg');" data-stellar-background-ratio="0.5">
    	<div class="container">
    ...
    <section class="ftco-section-parallax">
      ...
      <div class="container">
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url('application/assets/images/person_1.jpg')">
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url('application/assets/images/person_2.jpg')">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url('application/assets/images/person_3.jpg')">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
    	...
    	<div class="container-wrap">
    		<div class="row no-gutters">
					<div class="col-md-3 ftco-animate">
						<a href="gallery.html" class="gallery img d-flex align-items-center" style="background-image: url('application/assets/images/cer1.jpg');">
					...
					<div class="col-md-3 ftco-animate">
						<a href="gallery.html" class="gallery img d-flex align-items-center" style="background-image: url('application/assets/images/cer2.jpg');">
							<div class="icon mb-4 d-flex align-items-center justify-content-center">
    						<span class="icon-search"></span>
    					</div>
						</a>
...
<!--              <a href="blog-single.html" class="block-20" style="background-image: url('application/assets/images/image_1.jpg');">-->
<!--              </a>-->
...
<!--              <a href="blog-single.html" class="block-20" style="background-image: url('application/assets/images/image_2.jpg');">-->
<!--              </a>-->
<!--              <div class="text d-flex py-4">-->
<!--                <div class="meta mb-3">-->
<!--                  <div><a href="#">Sep. 20, 2018</a></div>-->
...
<!--              <a href="blog-single.html" class="block-20" style="background-image: url('application/assets/images/image_3.jpg');">-->
<!--              </a>-->
<!--              <div class="text d-flex py-4">-->
<!--                <div class="meta mb-3">-->
<!--                  <div><a href="#">Sep. 20, 2018</a></div>-->
    	...
    	<div class="container">
    		<div class="row">
	          ...
	          <div class="ftco-animate">
	            ...
	            <h2 class="mb-2">Give your Feedback</h2>
	          </div>
